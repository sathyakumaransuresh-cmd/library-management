...
def issuetab():
    ...
    def add_entry():
         ...
         df = pd.DataFrame({'Name': [name], 'book_name': [book],'issue_date':[idate],'return_date':[rdate]})
...
def stock():
    ...
    stock_window.geometry('1300x700')
...
issuebutton.place(x=250,y=350)
viewbutton.place(x=850,y=350)
stockbutton.place(x=550,y=600)
print(issuebutton)
print(viewbutton)
print(stockbutton)
